...
class GroupOrdersTest {
    ...
    fun `deve agrupar as ordens 1`() {
        ...
        Assertions.assertEquals(3, index["sell"]!![94000])
    }
    ...
    fun `deve agrupar as ordens 3`() {
        ...
        Assertions.assertEquals(1, index["sell"]!![94000])
        Assertions.assertEquals(1, index["sell"]!![94500])
        Assertions.assertEquals(1, index["sell"]!![94600])
    }
}